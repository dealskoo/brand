...
@section('body')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    <form action="{{ route('seller.brands.update',$brand) }}" method="post"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control" name="description" id="description" required tabindex="3"
                                          rows="4"
                                          placeholder="{{ __('brand::brand.description_placeholder') }}">{{ old('description',$brand->description) }}</textarea>
                            </div>
                        </div> <!-- end row -->
                        <div class="text-end">
